...
import RunMediaPanel from "./RunMediaPanel";
import {
...
export default function AdminRunEditor({ runId }: { runId: string }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <RunContextPanel metadata={(detail.run.metadata ?? {}) as RunMetadata} />

      <RunMediaPanel
        runId={runId}
        inputSource={detail.run.input_source ?? ""}
        media={(detail.run.metadata ?? {}).media ?? null}
      />
